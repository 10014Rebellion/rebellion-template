...
public class LEDSS extends SubsystemBase{
    ...
    private static final int kSlot1StartIdx = 0;
    private static final int kSlot1EndIdx = 49;
    ...
    public LEDSS() {
        ...
        m_anim1Chooser.setDefaultOption("Color Flow", AnimationType.ColorFlow);
    ...
    public void periodic() {
        ...
        if (m_anim1State != anim1Selection) {
            ...
            switch (m_anim1State) {
                ...
                case ColorFlow:
                    m_candle.setControl(
                        new ColorFlowAnimation(kSlot1StartIdx, kSlot1EndIdx).withSlot(0)
                            .withColor(kViolet)
                    );
                    break;
                case Rainbow:
                    m_candle.setControl(
                        new RainbowAnimation(kSlot1StartIdx, kSlot1EndIdx).withSlot(0)
                    );
                    break;
                case Twinkle:
                    m_candle.setControl(
                        new TwinkleAnimation(kSlot1StartIdx, kSlot1EndIdx).withSlot(0)
                            .withColor(kViolet)
                    );
                    break;
                case TwinkleOff:
                    m_candle.setControl(
                        new TwinkleOffAnimation(kSlot1StartIdx, kSlot1EndIdx).withSlot(0)
                            .withColor(kViolet)
                    );
                break;
            }
